...
// configuration step. It creates a namespace called `trans_include_detector`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", trans_include_detector::cmake::project_name, trans_include_detector::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", trans_include_detector::cmake::project_version);
      return EXIT_SUCCESS;
    }
